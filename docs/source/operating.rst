[myawesometmlsolutionml-534a] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolutionml-534a] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolutionml-534a] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/jeremykpark/tml-raspberrypi.git  \-\-env CHIP=arm64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=46121  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='jeremykpark'  \-\-env DOCKERUSERNAME='jeremykpark'  \-\-env MQTTUSERNAME='tsstestcluser234'  \-\-env KAFKACLOUDUSERNAME='KV4GV4NF2H33GAPT'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-arm64
...
.. important::
   jeremykpark/myawesometmlsolutionml-534a-arm64 (https://hub.docker.com/r/jeremykpark/myawesometmlsolutionml-534a-arm64)
...
.. code-block::
   ...
   docker run -d -p 5050:5050 -p 4040:4040 -p 6060:6060 \
          --env TSS=0 \
          --env SOLUTIONNAME=myawesometmlsolutionml-534a \
          --env SOLUTIONDAG=solution_preprocessing_dag-myawesometmlsolutionml-534a \
          ...
          jeremykpark/myawesometmlsolutionml-534a-arm64
...
[myawesometmlsolutionml-534a] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/jeremykpark/tml-raspberrypi/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolutionml-534a
...
.. important::
   https://myawesometmlsolutionml-534a.readthedocs.io
...
.. important::
   solution_preprocessing_dag-myawesometmlsolutionml-534a
...
.. important::
   VIPERHOST_PRODUCE=127.0.0.1, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=127.0.0.1, VIPERPORT_PREPROCESS=39243, VIPERHOST_PREPOCESS2=127.0.0.1, VIPERPORT_PREPROCESS2=39115, VIPERHOST_PREPOCESS_PGPT=127.0.0.1, VIPERPORT_PREPROCESS_PGPT=39473, VIPERHOST_ML=127.0.0.1, VIPERPORT_ML=32955, VIPERHOST_PREDCT=127.0.0.1, VIPERPORT_PREDICT=41381, HPDEHOST=127.0.0.1, HPDEPORT=44395, HPDEHOST_PREDICT=127.0.0.1, HPDEPORT_PREDICT=44109

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-4807-myawesometmlsolutionml-534a,solution_preprocessing_dag-myawesometmlsolutionml-534a, python-preprocess-9121-myawesometmlsolutionml-534a,solution_preprocessing_dag-myawesometmlsolutionml-534a, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
