Scaling [myawesometmlsolutionml-534a] With Kubernetes
===========================
...
Based on your TML solution [myawesometmlsolutionml-534a] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`myawesometmlsolutionml-534a.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlsolutionml-534a.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlsolutionml-534a.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f myawesometmlsolutionml-534a.yml

myawesometmlsolutionml-534a.yml
------------------------

.. important::
   Copy and Paste this YAML file: myawesometmlsolutionml-534a.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# myawesometmlsolutionml-534a.yml
     ...
     kind: Deployment
     metadata:
       name: myawesometmlsolutionml-534a
     spec:
       selector:
         matchLabels:
           app: myawesometmlsolutionml-534a
       ...
       template:
         ...
         spec:
           containers:
           - name: myawesometmlsolutionml-534a
             image: jeremykpark/myawesometmlsolutionml-534a-arm64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: SOLUTIONNAME
               value: 'myawesometmlsolutionml-534a'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-myawesometmlsolutionml-534a'
             - name: GITUSERNAME
               value: 'jeremykpark'
             - name: GITREPOURL
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlsolutionml-534a-visualization-service
       labels:
         app: myawesometmlsolutionml-534a-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolutionml-534a 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlsolutionml-534a.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlsolutionml-534a.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlsolutionml-534a.yml
